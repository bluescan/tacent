...
// Added by Tacent (2026-09-16): upstream brotli only exposes its version at
// runtime via BrotliDecoderVersion(); these compile-time constants match the
// vendored 1.2.0 release (2025-10-27) of the MIT-licensed brotli.
